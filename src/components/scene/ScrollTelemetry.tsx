...
export function ScrollTelemetry() {
  ...
  return (
    <div
      aria-hidden="true"
      className="pointer-events-none fixed bottom-5 right-5 z-30 hidden items-center gap-4 rounded-full border border-line bg-ink/70 px-4 py-2 font-mono text-[10px] tracking-[0.18em] text-muted backdrop-blur-md md:flex"
    >
      <span>
